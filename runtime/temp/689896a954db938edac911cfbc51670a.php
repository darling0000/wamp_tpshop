<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"D:\WWW\tpshop\public/../application/admin\view\login\login.html";i:1527430021;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="login-main">
			<form action="<?php echo \think\Request::instance()->url(); ?>" class="form" method="post">
                ...
                <div class="form-item verify">
                    ...
                    <img class="pull-right" src="<?php echo captcha_src(); ?>" alt="captcha" onclick="this.src='<?php echo captcha_src(); ?>' + '?' + Math.random()">
                    <div class="clear"></div>
                </div>
				<div class="form-item">
