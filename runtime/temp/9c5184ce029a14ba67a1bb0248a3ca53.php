<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\WWW\tpshop\public/../application/home\view\order\create.html";i:1529655508;s:47:"D:\WWW\tpshop\application\home\view\layout.html";i:1534408140;}*/ ?>
<!DOCTYPE html>
<html>
...
<div id="nav-bottom">
				...
				<div class="step-cont">
					<div class="addressInfo">
						<ul class="addr-detail">
							...
							<li class="addr-item">
								<div address_id="<?php echo $v['id']; ?>" class="con name <?php if(($k == 0)): ?>selected<?php endif; ?>"><a href="javascript:;" ><em><?php echo $v['consignee']; ?></em><span title="点击取消选择">&nbsp;</span></a></div>
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						      	<form action="addaddress" class="sui-form form-horizontal">
				...
				<div class="payshipInfo">
					...
					<div class="step-cont">
						<ul class="payType">
							...
							<li class="<?php if(($k == 'alipay')): ?>selected<?php endif; ?>" pay_type="alipay"><?php echo $v; ?><span title="点击取消选择"></span></li>
							<?php endforeach; ?>
							...
							<li>
								...
								<div class="sendGoods">
									...
									<ul class="yui3-g">
										...
										<li class="yui3-u-1-12">
											<div class="exit"><?php if(($v['goods_number'] > 0 )): ?>有货<?php else: ?>无货<?php endif; ?></div>
										</li>
									</ul>
									<?php endforeach; ?>
								</div>
	...
	<form id="orderForm" action="<?php echo url('save'); ?>" method="post" style="display:none">
	...
	<script>
		$(function () {
			...
			$('.submit').click(function () {
				...
				//从页面获取支付方式
				var pay_type = $('.payType').find('li.selected').attr('pay_type');
				//将支付方式放到隐藏表单中
