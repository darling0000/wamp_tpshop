<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\WWW\tpshop\public/../application/home\view\cart\index.html";i:1529581477;s:47:"D:\WWW\tpshop\application\home\view\layout.html";i:1534408140;}*/ ?>
<!DOCTYPE html>
<html>
			...
			<div class="cart-main">
				...
				<div class="cart-item-list">
					...
					<div class="cart-body">
						...
						<div class="cart-list">
							<ul class="goods-list yui3-g" goods_id="<?php echo $v['goods_id']; ?>" goods_attr_ids="<?php echo $v['goods_attr_ids']; ?>" cart_id="<?php echo $v['id']; ?>" number="<?php echo $v['number']; ?>">
								...
								<li class="yui3-u-5-24">
									...
									<?php echo $attr['attr_name']; ?>:<?php echo $attr['attr_value']; endforeach; ?>
									</div>
								</li>
