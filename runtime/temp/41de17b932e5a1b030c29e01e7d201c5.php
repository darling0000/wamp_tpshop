<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\WWW\tpshop\public/../application/home\view\login\login.html";i:1529216411;}*/ ?>
<!DOCTYPE html>
<html>
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" action="<?php echo url('dologin'); ?>" method="post">
								...
								<div class="logined">
									<a class="sui-btn btn-block btn-xlarge btn-danger login_btn" href="javascript:;" >登&nbsp;&nbsp;录</a>
								</div>
							</form>
