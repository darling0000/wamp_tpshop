<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\WWW\tpshop\public/../application/admin\view\type\type_list.html";i:1528891330;s:48:"D:\WWW\tpshop\application\admin\view\layout.html";i:1528732815;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="sidebar-nav">
    ...
    <div class="content">
        ...
        <div class="well">
        <a class="btn btn-primary" href="<?php echo url('type_add'); ?>">新增</a>
            <!-- table -->
                ...
                <tbody>
                    ...
                    <tr class="success">
                        ...
                        <td>
                            ...
                            <a href="<?php echo url('delete',['id'=>$v['id']]); ?>" onclick="if(confirm('确认删除？')) location.href='#'"> 删除 </a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
