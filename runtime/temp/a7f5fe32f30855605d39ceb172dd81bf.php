<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"D:\WWW\tpshop\public/../application/home\view\goods\detail.html";i:1529404776;s:47:"D:\WWW\tpshop\application\home\view\layout.html";i:1534408140;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="py-container">
                <div class="yui3-g Logo">
                    <div class="yui3-u Left logoArea">
                        <a class="logo-bd" title="品优购" href="index.html" target="_blank"></a>
                    </div>
                    ...
                    <div class="all-sorts-list">
                        ...
                        <div class="sort">
                            <div class="all-sort-list2">
                                ...
                                <div class="item bo">
                                    <h3><a href=""><?php echo $cate_one['cate_name']; ?></a></h3>
                                    <div class="item-list clearfix">
                                        <div class="subitem">
                                            <?php foreach($category as $cate_two): if(($cate_two['pid'] == $cate_one['id'])): ?>
                                            <dl class="fore1">
                                                <dt><a href=""><?php echo $cate_two['cate_name']; ?></a></dt>
                                                <dd>
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img jqimg="<?php echo $goodspics[0]['pics_big']; ?>" src="<?php echo $goodspics[0]['pics_sma']; ?>" /></span>
						</div>
						<!--下方的缩略图-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<?php foreach($new_goodsattr[$v['id']] as $k=>$attr_value): ?>
								<dd><a goods_attr_id="<?php echo $attr_value['id']; ?>" href="javascript:;" class="<?php if(($k == 0)): ?>selected<?php endif; ?>"><?php echo $attr_value['attr_value']; ?><span title="点击取消选择">&nbsp;</span></a></dd>
								<?php endforeach; ?>
							</dl>
							<?php endif; endforeach; ?>
						</div>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="javascript:'" id="addcart" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									...
									<li><?php echo $v['attr_name']; ?>:<?php echo $new_goodsattr[$v['id']][0]['attr_value']; ?></li>
									<?php endif; endforeach; ?>
								</ul>
...
//			}
//			//普通标签绑定点击事件
//			var a = document.querySelectorAll('#specification a');
...
//					}
//					//获取当前行的a标签
//					var row_a = this.parentNode.parentNode.querySelectorAll('a');
//					for(var j=0;j<row_a.length;j++){
//						var new_className = row_a[j].className.replace('selected','');
//						row_a[j].className = new_className;
//					}
	...
	<script type="text/javascript">
		$(function () {
			...
			$('#addcart').click(function () {
				...
				//从页面获取选中属性值 取主键id值拼接成字符串 放到隐藏表单中
				var a = $('.selected'); //$('#specification').find('a.selected')
				//遍历 获取每一个a标签的goods_attr_id值 拼接成一个字符串参数
				var goods_attr_ids = '';
				$.each(a,function (i,v) {
				...
				//将最终拼接的参数goods_attr_ids 放到隐藏表单中
